...
Megnyitás után add meg a saját lapod „Adatok” táblázatának 12 értékét. Az oldal kiírja a Moodle-be beírandó értékeket (F, M_O, r_G), a teljes részeredmény-táblázatot és a lépésenkénti levezetést a megadott számokkal. Egy méretarányos axonometrikus vázlatot is rajzol.
...
- F₁ a B pontban hat, F₂ az E pontban +y irányú, F₃ a C pontban +z irányú
